================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TstMyQueue Project Overview
===============================================================================

The application wizard has created this TstMyQueue application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TstMyQueue application.
...
TstMyQueue.h
    ...
    project specific headers and declares the CTstMyQueueApp application class.

TstMyQueue.cpp
    This is the main application source file that contains the application
    class CTstMyQueueApp.
...
TstMyQueueDlg.h, TstMyQueueDlg.cpp - the dialog
    These files contain your CTstMyQueueDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named TstMyQueue.pch and a precompiled types file named StdAfx.obj.
