================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TstMfiProtocolDll Project Overview
===============================================================================

The application wizard has created this TstMfiProtocolDll application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TstMfiProtocolDll application.

TstMfiProtocolDll.vcproj
...
TstMfiProtocolDll.h
    ...
    project specific headers and declares the CTstMfiProtocolDllApp application class.

TstMfiProtocolDll.cpp
    This is the main application source file that contains the application
    class CTstMfiProtocolDllApp.

TstMfiProtocolDll.rc
...
TstMfiProtocolDllDlg.h, TstMfiProtocolDllDlg.cpp - the dialog
    These files contain your CTstMfiProtocolDllDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named TstMfiProtocolDll.pch and a precompiled types file named StdAfx.obj.
