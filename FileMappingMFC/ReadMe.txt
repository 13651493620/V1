================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : FileMappingMFC Project Overview
===============================================================================

The application wizard has created this FileMappingMFC application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your FileMappingMFC application.

FileMappingMFC.vcproj
...
FileMappingMFC.h
    ...
    project specific headers and declares the CFileMappingMFCApp application class.

FileMappingMFC.cpp
    This is the main application source file that contains the application
    class CFileMappingMFCApp.
...
FileMappingMFCDlg.h, FileMappingMFCDlg.cpp - the dialog
    These files contain your CFileMappingMFCDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named FileMappingMFC.pch and a precompiled types file named StdAfx.obj.
