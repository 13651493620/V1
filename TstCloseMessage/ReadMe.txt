================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TstCloseMessage Project Overview
===============================================================================

The application wizard has created this TstCloseMessage application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TstCloseMessage application.

TstCloseMessage.vcproj
...
TstCloseMessage.h
    ...
    project specific headers and declares the CTstCloseMessageApp application class.

TstCloseMessage.cpp
    This is the main application source file that contains the application
    class CTstCloseMessageApp.
...
TstCloseMessageDlg.h, TstCloseMessageDlg.cpp - the dialog
    These files contain your CTstCloseMessageDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named TstCloseMessage.pch and a precompiled types file named StdAfx.obj.
