================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TestISpectrums Project Overview
===============================================================================

The application wizard has created this TestISpectrums application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TestISpectrums application.

TestISpectrums.vcproj
...
TestISpectrums.h
    ...
    project specific headers and declares the CTestISpectrumsApp application class.

TestISpectrums.cpp
    This is the main application source file that contains the application
    class CTestISpectrumsApp.
...
TestISpectrumsDlg.h, TestISpectrumsDlg.cpp - the dialog
    These files contain your CTestISpectrumsDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named TestISpectrums.pch and a precompiled types file named StdAfx.obj.
